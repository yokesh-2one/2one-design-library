...
const NAV = [
  ...
  { grp: 'Explore', items: [['/dls.html', 'What is a DLS?', ''], ['/graph.html', 'Knowledge graph', '198']] },
]
        ...
        <SidebarInset className="min-w-0">
          ...
          <div className="mx-auto w-full min-w-0 max-w-7xl px-6 pb-32 lg:px-10">
            ...
            <section id="charts" className="g-section">
              ...
              <p className="g-lede">31 chart templates across every type, grayscale by default (the <code>--chart-1…5</code> tokens map to the neutral ramp, with no hues). One of each type is shown; the full set lives in <code>src/blocks/charts/</code>.</p>
              <div className="g-grid2">
                <ChartArea />
                <ChartBarMultiple />
                <ChartLineMultiple />
            ...
            <section id="index" className="g-section">
              ...
              <p className="g-lede">Every export in the package: 54 shadcn primitives and 3 2one-only components. Select any to open it in the <a className="underline underline-offset-2" href="/graph.html">knowledge graph</a>.</p>
              <div className="g-index">
