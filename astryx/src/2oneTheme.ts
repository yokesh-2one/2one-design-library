...
const neutralSyntax = defineSyntaxTheme({
  name: 'xds-neutral',
  tokens: {
    keyword: ['#313131', '#c7c7c7'], // purple T30/T80
    string: ['#005600', '#a6d2a2'], // green (sat T30 / pastel T80)
    comment: ['#737373', '#a3a3a3'], // neutral
    number: ['#6e3500', '#ffb37f'], // orange
    function: ['#383838', '#c3c3c3'], // blue T30/T80 H=255
    type: ['#313131', '#c7c7c7'], // purple
    ...
    attribute: ['#424242', '#bebebe'], // yellow
...
// 2one theme — derived from Astryx's MIT-licensed neutralTheme (a grayscale
// spine that already matches shadcn/Tailwind) and re-skinned to the 2one DLS:
// Satoshi headings + Inter body, base 16, near-black accent, danger #c81e1e /
// success #15803d. Astryx's categorical hues are left intact (used for status
// and data only, never as brand colour).
export const twoOneTheme = defineTheme({
  name: '2one',

  // 2one typography: Satoshi headings, Inter body, base 16.
  typography: {
  ...
  tokens: {
    ...
    '--color-text-secondary': ['#525252', '#c2c2c8'], // 2one: dark bumped from #a3a3a3 (Lc 51) to clear APCA Lc 60
    '--color-text-disabled': ['#a3a3a3', '#525252'],
    '--color-text-accent': ['#09090b', '#fafafa'],
    ...
    // Icon
    '--color-icon-accent': ['#09090b', '#fafafa'],
    '--color-icon-primary': ['#09090b', '#fafafa'],
    ...
    '--color-success': ['#15803d', '#9fe59b'],
    '--color-error': ['#c81e1e', '#ffc6c1'],
    '--color-warning': ['#585858', '#fdcf4f'],
    '--color-success-muted': ['#c5e5c0', '#84c9803D'],
    '--color-error-muted': ['#dbdbdb', '#ff9e973D'],
    '--color-warning-muted': ['#dcdcdc', '#b2b2b23D'],

    // Border
    '--color-border': ['#cccccc', '#606069'], // 2one: opaque hairline; Astryx's faint alpha (#00000014/#FFFFFF1A) was Lc <15 on every surface (incl. the tinted #f1f1f1 body)
    ...
    '--color-background-red': ['#dbdbdb', '#ff9e973D'],
    '--color-border-red': ['#c7c7c7', '#ff6f6c'],
    '--color-icon-red': ['#89001a', '#ff9e97'],
    '--color-text-red': ['#89001a', '#ffc6c1'],

    // Orange  H=55 — source #d57113
    '--color-background-orange': ['#e5e5e5', 'var(--color-neutral)'] /* 2one: desaturated */,
    '--color-border-orange': ['#d4d4d4', '#262626'] /* 2one: desaturated */,
    '--color-icon-orange': ['#525252', '#a3a3a3'] /* 2one: desaturated */,
    '--color-text-orange': ['#262626', '#e5e5e5'] /* 2one: desaturated */,
    ...
    // consistency.
    '--color-background-yellow': ['#e5e5e5', 'var(--color-neutral)'] /* 2one: desaturated */,
    '--color-border-yellow': ['#d4d4d4', '#262626'] /* 2one: desaturated */,
    '--color-icon-yellow': ['#525252', '#a3a3a3'] /* 2one: desaturated */,
    '--color-text-yellow': ['#262626', '#e5e5e5'] /* 2one: desaturated */,
    ...
    '--color-background-teal': ['#e5e5e5', 'var(--color-neutral)'] /* 2one: desaturated */,
    '--color-border-teal': ['#d4d4d4', '#262626'] /* 2one: desaturated */,
    '--color-icon-teal': ['#525252', '#a3a3a3'] /* 2one: desaturated */,
    '--color-text-teal': ['#262626', '#e5e5e5'] /* 2one: desaturated */,

    // Cyan  H=215 — source #545454
    // Same L=0.87 C=0.065 pastel as teal (luminance overshoot compensation).
    '--color-background-cyan': ['#e5e5e5', 'var(--color-neutral)'] /* 2one: desaturated */,
    '--color-border-cyan': ['#d4d4d4', '#262626'] /* 2one: desaturated */,
    '--color-icon-cyan': ['#525252', '#a3a3a3'] /* 2one: desaturated */,
    '--color-text-cyan': ['#262626', '#e5e5e5'] /* 2one: desaturated */,

    // Blue  H=255 — source #5e5e5e
    //   T50 #5e5e5e reserved for filled Info badge / progressbar / inset hover.
    '--color-background-blue': ['#e5e5e5', 'var(--color-neutral)'] /* 2one: desaturated */,
    '--color-border-blue': ['#d4d4d4', '#262626'] /* 2one: desaturated */,
    '--color-icon-blue': ['#525252', '#a3a3a3'] /* 2one: desaturated */,
    '--color-text-blue': ['#262626', '#e5e5e5'] /* 2one: desaturated */,

    // Purple  H=320 — source #4b4b4b
    '--color-background-purple': ['#e5e5e5', 'var(--color-neutral)'] /* 2one: desaturated */,
    '--color-border-purple': ['#d4d4d4', '#262626'] /* 2one: desaturated */,
    '--color-icon-purple': ['#525252', '#a3a3a3'] /* 2one: desaturated */,
    '--color-text-purple': ['#262626', '#e5e5e5'] /* 2one: desaturated */,

    // Pink  H=355 — source #b10e69
    '--color-background-pink': ['#e5e5e5', 'var(--color-neutral)'] /* 2one: desaturated */,
    '--color-border-pink': ['#d4d4d4', '#262626'] /* 2one: desaturated */,
    '--color-icon-pink': ['#525252', '#a3a3a3'] /* 2one: desaturated */,
    '--color-text-pink': ['#262626', '#e5e5e5'] /* 2one: desaturated */,
    ...
    '--shadow-inset-hover': 'inset 0px 0px 0px 2px #5e5e5e4D',
    '--shadow-inset-selected': 'inset 0px 0px 0px 2px #5e5e5e80',
  ...
  components: {
    ...
    badge: {
      ...
      'variant:info': {
        // Light: T50 #5e5e5e (palette saturated stop)
        // Dark : T60 stop from dark-mode tonal palette of source #5e5e5e
        backgroundColor: 'light-dark(#5e5e5e, #999999)',
    ...
    statusdot: {
      ...
      'variant:accent': {backgroundColor: 'light-dark(#5e5e5e, #999999)'},
    },
